...
submit.addEventListener('click', () => {
  ...
  if (getCourseValue === '' && grady === 'SELECT' && unity === 'SELECT') {
    courses.innerHTML += '';
    alert('can you please enter course name, marks and credits')
  } else if (getCourseValue === '' && grady === 'SELECT') {
    courses.innerHTML += '';
    alert('Kindly input course name and select marks');
    ...
    courses.innerHTML += '';
    alert('Kindly select course mark and its credit unit');
  } else if (getCourseValue === '') {
    courses.innerHTML += '';
    alert('Kindly input course name');
  } else if (grady === 'SELECT') {
    courses.innerHTML += '';
    alert('Kindly select course mark');
